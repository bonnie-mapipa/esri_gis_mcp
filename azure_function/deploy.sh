...
# Azure Function Deployment Script for eThekwini GIS MCP
# This script deploys the MCP as an Azure Function App

set -e

# Configuration
RESOURCE_GROUP="rg-ethekwini-gis-mcp"
FUNCTION_APP_NAME="func-ethekwini-gis-mcp"
STORAGE_ACCOUNT="stethekwinigismcp"
LOCATION="South Africa North"  # Johannesburg region
RUNTIME="python"
...
az group create \
    --name $RESOURCE_GROUP \
    --location "$LOCATION" \
    --tags project=ethekwini-gis-mcp environment=production
...
az functionapp config appsettings set \
    ...
    --resource-group $RESOURCE_GROUP \
    --settings \
        ETHEKWINI_REFRESH_INTERVAL=900 \
        ETHEKWINI_MAX_RECORDS=100 \
        ETHEKWINI_TIMEOUT=60 \
